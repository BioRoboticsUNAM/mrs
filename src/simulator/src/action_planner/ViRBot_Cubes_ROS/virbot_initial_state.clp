...
; Objects definitions
	...
	( item (type Objects) (name book-shelf)(room studio)(image shelf)( attributes no-pick brown)(pose 0.2 0.16 0.0))
	...
	( item (type Objects) (name apple)(room corridor)(zone deposit)(image apple)(attributes pick)(lower sushi)(pose 0.40 1.0 0.0))
	( item (type Objects) (name orange)(zone any)(image orange)(attributes pick)(pose 0.93 0.70 0.0))
	( item (type Objects) (name banana)(zone any)(image banana)(attributes pick)(pose 0.90 1.70 0.0))
	( item (type Objects) (name sushi)(room corridor)(zone deposit)(image sushi)(attributes pick)(upper apple)(lower milk)(pose 0.30 1.0 0.0))
	( item (type Objects) (name milk)(room corridor)(zone deposit)(image milk)(attributes pick)(upper sushi)(pose 0.20 1.0 0.0))

	( item (type Objects) (name soap)(room corridor)(zone deposit)(image soap)(attributes pick)(lower perfume)(pose 0.50 1.1 0.0))
	( item (type Objects) (name perfume)(room corridor)(zone deposit)(image perfume)(attributes pick)(upper soap)(lower shampoo)(pose 0.37 1.1 0.0))
	( item (type Objects) (name shampoo)(room corridor)(zone deposit)(image shampoo)(attributes pick)(upper perfume)(pose 0.20 1.1 0.0))
...
; Rooms definitions
	...
	( Room (name library)(zone book-shelf)(zones dummy1 frontexit frontentrance deposit dummy2)(center 0.2 0.16))
...
;stacks definitions
	...
	; State definition
	;(state (attribute location)(obj orange)(value kitchen))
)
