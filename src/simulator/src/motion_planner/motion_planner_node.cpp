...
//    ros::Rate loop_rate(10);
    ...
    ros::Subscriber params_act_manipulator = n.subscribe("action_planner_manipulator_msg", 100, msgCallbackActionPlannerManipulator);
